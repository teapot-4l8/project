...
uint64_t AntiFrida::frida_find_library_base(std::string library_name, char **library_path) {// "libc", &libc_path
    uint64_t result = 0;
...
uint64_t AntiFrida::frida_find_library_space_base(uint64_t base, uint32_t page_size) {// start, page_size
