...
public final class e {
    public static File a(Context context, String str) {
        ...
        if (context == null || (filesDir = context.getFilesDir()) == null) {
            cn.jiguang.an.d.f("FileUtils", "can't get file :" + str);
            return null;
        }
    ...
    public static void a(File file) {
        if (file != null) {
            try {
                if (file.exists()) {
                    file.delete();
                    cn.jiguang.an.d.b("FileUtils", "delete File:" + file.getPath());
                }
    ...
    public static boolean a(File file, String str) {
        ...
        if (str != null) {
            try {
                ...
                cn.jiguang.an.d.f("FileUtils", "getBytes exception:" + th);
                return false;
            }
        } else {
            bytes = null;
    ...
    private static boolean a(File file, byte[] bArr) {
        ...
        if (file == null || file.isDirectory()) {
            cn.jiguang.an.d.f("FileUtils", "file should not be null or a directory");
            return false;
        }
        ...
        if (bArr == null) {
            try {
                ...
                th = th2;
                try {
                    cn.jiguang.an.d.f("FileUtils", "save to file exception:" + th + " path = " + file.getAbsolutePath());
                    return false;
                } finally {
    ...
    public static String b(File file) {
        ...
        try {
            ...
            cn.jiguang.an.d.b("FileUtils", "can't encoding, give up read :" + e2);
            return null;
        }
    }
    ...
    private static byte[] d(File file) {
        ...
        try {
            ...
            th = th2;
            try {
                cn.jiguang.an.d.b("FileUtils", "can't read, give up read. e:" + th);
                return null;
            } finally {
