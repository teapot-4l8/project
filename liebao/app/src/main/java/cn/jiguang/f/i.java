...
public final class i {
    ...
    private static Pattern f4077a = Pattern.compile("((2[0-4]\\d|25[0-5]|[01]?\\d{1,2})\\.){3}(2[0-4]\\d|25[0-5]|[01]?\\d{1,2})");

    /* renamed from: b  reason: collision with root package name */
    private static SimpleDateFormat f4078b = new SimpleDateFormat("HHH:mm:ss:SSS", Locale.ENGLISH);
    ...
    public static String a(byte[] bArr) {
        try {
            ...
            cn.jiguang.an.d.b("StringUtils", "Get SHA1 error");
            return "";
        }
    }
    ...
    public static String e(String str) {
        try {
            ...
            cn.jiguang.an.d.b("StringUtils", "Get MD5 error");
            return "";
        }
    }
    ...
    public static boolean f(String str) {
        ...
        return f4077a.matcher(str).matches();
    }
    ...
    public static byte[] j(String str) {
        ...
        try {
            ...
            cn.jiguang.an.d.i("StringUtils", "stringToUtf8Bytes error:" + th.getMessage());
            return str.getBytes();
        }
    }
