...
public final class h implements Serializable, Comparable {
    ...
    public static final h f3894a;

    /* renamed from: b  reason: collision with root package name */
    public static final h f3895b;
    ...
    private h(String str, h hVar) {
        ...
        if (str.equals("@")) {
            ...
            a(str, hVar.f3896c, hVar.a(i2), hVar.b());
            return;
        } else {
            hVar2 = f3894a;
        }
    ...
    private final int a(int i2) {
        ...
        if (i2 < 7) {
            return ((int) (this.f3897d >>> ((7 - i2) * 8))) & 255;
        }
        int a2 = a(6);
    ...
    public static h a(h hVar, h hVar2) {
        ...
        h hVar3 = new h();
        b(hVar, hVar3);
        hVar3.a(hVar2.f3896c, hVar2.a(0), hVar2.b());
        return hVar3;
    }
    ...
    public static h a(String str, h hVar) {
        return (!str.equals("@") || hVar == null) ? str.equals(".") ? f3894a : new h(str, hVar) : hVar;
    }
    ...
    private final void a(int i2, int i3) {
        ...
        int i4 = (7 - i2) * 8;
        long j2 = this.f3897d & ((255 << i4) ^ (-1));
        this.f3897d = j2;
        this.f3897d = (i3 << i4) | j2;
    }
    ...
    private final void a(byte[] bArr, int i2, int i3) {
        ...
        if (length != 0) {
            System.arraycopy(this.f3896c, a(0), bArr3, 0, length);
        }
    ...
    private final int b() {
        return (int) (this.f3897d & 255);
    }

    private final void b(int i2) {
        long j2 = this.f3897d & (-256);
        this.f3897d = j2;
        this.f3897d = j2 | i2;
    }
    ...
    private static final void b(h hVar, h hVar2) {
        if (hVar.a(0) == 0) {
            hVar2.f3896c = hVar.f3896c;
            hVar2.f3897d = hVar.f3897d;
            return;
        }
        int a2 = hVar.a(0);
        int length = hVar.f3896c.length - a2;
        int b2 = hVar.b();
        byte[] bArr = new byte[length];
        hVar2.f3896c = bArr;
        System.arraycopy(hVar.f3896c, a2, bArr, 0, length);
    ...
    public final void a(d dVar) {
        ...
        if (b2 == 0) {
            ...
            byte[] bArr2 = new byte[this.f3896c.length - a(0)];
            int a2 = a(0);
            int i2 = 0;
            for (int i3 = 0; i3 < b2; i3++) {
                byte[] bArr3 = this.f3896c;
                byte b3 = bArr3[a2];
                if (b3 > 63) {
                    throw new IllegalStateException("invalid label");
                }
    ...
    public final boolean a() {
        int b2 = b();
        return b2 != 0 && this.f3896c[a(b2 - 1)] == 0;
    }
    ...
    public final int compareTo(Object obj) {
        ...
        for (int i3 = 1; i3 <= i2; i3++) {
            int a2 = a(b2 - i3);
            int a3 = hVar.a(b3 - i3);
            byte b4 = this.f3896c[a2];
            byte b5 = hVar.f3896c[a3];
            for (int i4 = 0; i4 < b4 && i4 < b5; i4++) {
                byte[] bArr = i;
                int i5 = bArr[this.f3896c[(i4 + a2) + 1] & 255] - bArr[hVar.f3896c[(i4 + a3) + 1] & 255];
                if (i5 != 0) {
                    return i5;
                }
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (hVar.f3898e == this.f3898e && hVar.b() == b()) {
            byte[] bArr = hVar.f3896c;
            int a2 = hVar.a(0);
            int b2 = b();
            int a3 = a(0);
            int i2 = 0;
            while (i2 < b2) {
                ...
                while (i4 < b3) {
                    ...
                    int i5 = i3 + 1;
                    int i6 = a2 + 1;
                    if (bArr3[this.f3896c[i3] & 255] != bArr3[bArr[a2] & 255]) {
                        return false;
                    }
                    i4++;
                    a2 = i6;
    ...
    public final String toString() {
        ...
        while (true) {
            ...
            stringBuffer.append(a(this.f3896c, a2));
            a2 += b3 + 1;
            i2++;
        }
        return stringBuffer.toString();
