...
public final class b {
    ...
    public static SSLTrustManager f3770a;
            ...
            if (f3770a == null) {
                try {
                    if (!TextUtils.isEmpty("-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----")) {
                        f3770a = new SSLTrustManager("-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----");
                    }
                } catch (Throwable unused) {
                }
            }
            if (f3770a != null) {
                httpRequest.setSslTrustManager(f3770a);
            }
            httpRequest.setRequestProperty("Accept", "application/jason");
            httpRequest.setRequestProperty("Accept-Encoding", "gzip");
            httpRequest.setRequestProperty("X-App-Key", cn.jiguang.am.a.a(context));
            httpRequest.setRequestProperty("Charset", "UTF-8");
            String a2 = cn.jiguang.bb.d.a(i);
            httpRequest.setHaveRspData(false);
            httpRequest.setRspDatazip(false);
            httpRequest.setRequestProperty("Authorization", "Basic " + k.a(context, cn.jiguang.f.i.a(bArr), a2));
            while (i2 > 0) {
                i2--;
                HttpResponse httpPost = HttpUtils.httpPost(context, httpRequest);
                int responseCode = httpPost.getResponseCode();
                cn.jiguang.an.d.c("HttpHelper", "status code:" + responseCode + " retry left:" + i2);
                if (responseCode == 200) {
    ...
    public static n a(String str, String str2, Context context, boolean z, int i, int i2) {
        try {
            try {
                try {
                    byte[] a2 = cn.jiguang.f.k.a(str2.getBytes("UTF-8"));
                    HttpRequest httpRequest = new HttpRequest(str);
                    httpRequest.setConnectTimeout(BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
                    httpRequest.setReadTimeout(BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
                    httpRequest.setDoOutPut(true);
                    httpRequest.setDoInPut(true);
                    httpRequest.setUseCaches(false);
                    String a3 = cn.jiguang.bb.d.a(cn.jiguang.bb.d.a());
                    byte[] a4 = cn.jiguang.bb.d.a(a2, a3, "0102030405060708", true);
                    ...
                    while (i > 0) {
                        ...
                        HttpResponse httpPost = HttpUtils.httpPost(context, httpRequest);
                        int responseCode = httpPost.getResponseCode();
                        cn.jiguang.an.d.c("HttpHelper", "status code:" + responseCode + " retry left:" + i);
                        if (responseCode == 200) {
                            return new n(0, httpPost.getResponseBody());
                        }
                        if (responseCode == 401) {
                    ...
                    return new n(-2, "zip err:" + e2.getMessage());
                }
            } catch (AssertionError e3) {
                return new n(-2, "Catch AssertionError to avoid http close crash - " + e3.getMessage());
            } catch (Exception e4) {
            ...
            return new n(-2, "Exception - " + e5.getMessage());
        }
    }
}
