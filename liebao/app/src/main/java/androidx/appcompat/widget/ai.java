...
public class ai extends ViewGroup {
    ...
    public ai(Context context, AttributeSet attributeSet, int i) {
        ...
        aw a2 = aw.a(context, attributeSet, R.styleable.LinearLayoutCompat, i, 0);
        androidx.core.h.w.a(this, context, R.styleable.LinearLayoutCompat, attributeSet, a2.a(), i, 0);
        ...
        this.mWeightSum = a2.a(R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a2.a(R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a2.a(R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a2.a(R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a2.a(R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a2.e(R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a2.b();
    }
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i2)) {
                ...
                if (a2) {
                    ...
                    left2 = (virtualChildAt.getLeft() - aVar.leftMargin) - this.mDividerWidth;
                }
                ...
                if (virtualChildAt == null) {
                    ...
                    if (virtualChildAt.getVisibility() == 8) {
                        ...
                        if (mode2 == 1073741824 && aVar.height == 0 && aVar.g > 0.0f) {
                            ...
                            this.mTotalLength = Math.max(i29, aVar.topMargin + i29 + aVar.bottomMargin);
                            max = i22;
                            view = virtualChildAt;
                            i17 = i24;
                            i14 = virtualChildCount;
                            ...
                            view = virtualChildAt;
                            this.mTotalLength = Math.max(i33, i33 + measuredHeight + aVar.topMargin + aVar.bottomMargin + getNextLocationOffset(view));
                            max = z3 ? Math.max(measuredHeight, i32) : i32;
                        }
                        if (i19 >= 0 && i19 == i18 + 1) {
                            this.mBaselineChildTop = this.mTotalLength;
                        }
                        if (i18 < i19 && aVar.g > 0.0f) {
                        ...
                        int i34 = aVar.leftMargin + aVar.rightMargin;
                ...
                if (z3 && (i39 == Integer.MIN_VALUE || i39 == 0)) {
                    ...
                    while (i41 < i3) {
                        ...
                        if (virtualChildAt2 == null) {
                            ...
                            this.mTotalLength = Math.max(i42, i42 + i36 + aVar2.topMargin + aVar2.bottomMargin + getNextLocationOffset(virtualChildAt2));
                        }
                        i41++;
                        i26 = 8;
                    }
                ...
                if (z4 || (i43 != 0 && f > 0.0f)) {
                    ...
                    while (i46 < i3) {
                        ...
                        if (virtualChildAt3.getVisibility() == 8) {
                            ...
                            int i48 = aVar3.leftMargin + aVar3.rightMargin;
                            ...
                            if (mode != 1073741824) {
                                ...
                                if (aVar3.width == -1) {
                                    ...
                                    boolean z7 = !z5 && aVar3.width == i9;
                                    int i49 = this.mTotalLength;
                                    this.mTotalLength = Math.max(i49, virtualChildAt3.getMeasuredHeight() + i49 + aVar3.topMargin + aVar3.bottomMargin + getNextLocationOffset(virtualChildAt3));
                                    z5 = z7;
                                    i4 = i8;
                                    i45 = max4;
                                    f = f6;
                            ...
                            this.mTotalLength = Math.max(i492, virtualChildAt3.getMeasuredHeight() + i492 + aVar3.topMargin + aVar3.bottomMargin + getNextLocationOffset(virtualChildAt3));
                            z5 = z7;
                            i4 = i8;
                            i45 = max42;
                            f = f6;
                    ...
                    if (z3 && i39 != 1073741824) {
                        for (int i50 = 0; i50 < i3; i50++) {
                            ...
                            if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((a) virtualChildAt4.getLayoutParams()).g > 0.0f) {
        ...
        while (true) {
            ...
            if (virtualChildAt == null) {
                ...
                if (mode == i15 && aVar.width == 0 && aVar.g > 0.0f) {
                    if (z7) {
                        this.mTotalLength += aVar.leftMargin + aVar.rightMargin;
                    } else {
                        int i22 = this.mTotalLength;
                        this.mTotalLength = Math.max(i22, aVar.leftMargin + i22 + aVar.rightMargin);
                    }
                    if (z5) {
                        ...
                        if (z3 && (baseline2 = view.getBaseline()) != -1) {
                            int i24 = ((((aVar.h >= 0 ? this.mGravity : aVar.h) & 112) >> 4) & (-2)) >> 1;
                    ...
                    if (z7) {
                        view = virtualChildAt;
                        this.mTotalLength += aVar.leftMargin + measuredWidth + aVar.rightMargin + getNextLocationOffset(view);
                    } else {
                        view = virtualChildAt;
                        int i28 = this.mTotalLength;
                        this.mTotalLength = Math.max(i28, i28 + measuredWidth + aVar.leftMargin + aVar.rightMargin + getNextLocationOffset(view));
                    }
                    if (z2) {
                ...
                i21 = View.combineMeasuredStates(i21, view.getMeasuredState());
                if (z3) {
                    int i242 = ((((aVar.h >= 0 ? this.mGravity : aVar.h) & 112) >> 4) & (-2)) >> 1;
        ...
        if (z11 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i33 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    a aVar2 = (a) virtualChildAt2.getLayoutParams();
                    if (z7) {
                        this.mTotalLength += aVar2.leftMargin + i17 + aVar2.rightMargin + getNextLocationOffset(virtualChildAt2);
                    } else {
                        int i34 = this.mTotalLength;
                        i11 = max;
                        this.mTotalLength = Math.max(i34, i34 + i17 + aVar2.leftMargin + aVar2.rightMargin + getNextLocationOffset(virtualChildAt2));
                        i33++;
                        max = i11;
                    }
                }
        ...
        if (z8 || (i36 != 0 && f2 > 0.0f)) {
            ...
            while (i40 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (z7) {
                        this.mTotalLength += virtualChildAt3.getMeasuredWidth() + aVar3.leftMargin + aVar3.rightMargin + getNextLocationOffset(virtualChildAt3);
                        f = f2;
                    } else {
                        int i43 = this.mTotalLength;
                        f = f2;
                        this.mTotalLength = Math.max(i43, virtualChildAt3.getMeasuredWidth() + i43 + aVar3.leftMargin + aVar3.rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
                    ...
                    if (z9) {
                        ...
                        if (aVar3.height == -1) {
                            ...
                            if (z12 && (baseline = virtualChildAt3.getBaseline()) != i9) {
                                int i45 = ((((aVar3.h >= 0 ? this.mGravity : aVar3.h) & 112) >> 4) & (-2)) >> 1;
                    ...
                    z = false;
                    if (z12) {
                        int i452 = ((((aVar3.h >= 0 ? this.mGravity : aVar3.h) & 112) >> 4) & (-2)) >> 1;
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                int a2 = androidx.core.h.e.a(i13, androidx.core.h.w.g(this)) & 7;
                if (a2 == 1) {
                    ...
                    paddingTop = i15 + measuredHeight + aVar.bottomMargin + getNextLocationOffset(virtualChildAt);
                }
                i7 = i5 - i6;
                int i142 = i7;
                if (hasDividerBeforeChildAt(i12)) {
                }
                int i152 = paddingTop + aVar.topMargin;
                setChildFrame(virtualChildAt, i142, i152 + getLocationOffset(virtualChildAt), measuredWidth, measuredHeight);
                i12 += getChildrenSkipCount(virtualChildAt, i12);
                paddingTop = i152 + measuredHeight + aVar.bottomMargin + getNextLocationOffset(virtualChildAt);
            }
            i12++;
        }
    }
    ...
    */
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        int a3 = androidx.core.h.e.a(8388615 & i15, androidx.core.h.w.g(this));
        if (a3 == 1) {
        ...
        while (i17 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (z) {
                    ...
                    if (aVar.height != -1) {
                        ...
                        if (i10 != 16) {
                            ...
                            i12 = (paddingBottom - measuredHeight) - aVar.bottomMargin;
                            if (i8 != -1) {
                        ...
                        int i20 = aVar.leftMargin + paddingLeft;
                        i13 = paddingTop;
                        ...
                        paddingLeft = i20 + measuredWidth + aVar.rightMargin + getNextLocationOffset(virtualChildAt);
                        i17++;
                ...
                int i202 = aVar.leftMargin + paddingLeft;
                i13 = paddingTop;
                setChildFrame(virtualChildAt, i202 + getLocationOffset(virtualChildAt), i12, measuredWidth, measuredHeight);
                i17 = i19 + getChildrenSkipCount(virtualChildAt, i18);
                paddingLeft = i202 + measuredWidth + aVar.rightMargin + getNextLocationOffset(virtualChildAt);
                i17++;
                virtualChildCount = i7;
                i16 = i11;
                paddingTop = i13;
