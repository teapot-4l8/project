...
public final class ViewPager2 extends ViewGroup {
    ...
    private RecyclerView.f mSavedItemAnimator;
    ...
    public ViewPager2(Context context) {
        ...
        this.mCurrentItemDataSetChangeObserver = new DataSetChangeObserver() { // from class: androidx.viewpager2.widget.ViewPager2.1
            @Override // androidx.viewpager2.widget.ViewPager2.DataSetChangeObserver, androidx.recyclerview.widget.RecyclerView.c
    ...
    private RecyclerView.k enforceChildFillListener() {
    ...
    public void setAdapter(RecyclerView.a aVar) {
        ...
        this.mCurrentItem = 0;
        restorePendingState();
        this.mAccessibilityProvider.onAttachAdapter(aVar);
        registerCurrentItemDataSetTracker(aVar);
    }

    private void registerCurrentItemDataSetTracker(RecyclerView.a<?> aVar) {
        if (aVar != null) {
            aVar.registerAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    private void unregisterCurrentItemDataSetTracker(RecyclerView.a<?> aVar) {
        if (aVar != null) {
            aVar.unregisterAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }
    ...
    public class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public boolean performAccessibilityAction(RecyclerView.p pVar, RecyclerView.u uVar, int i, Bundle bundle) {
            ...
            return super.performAccessibilityAction(pVar, uVar, i, bundle);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.i
        public void onInitializeAccessibilityNodeInfo(RecyclerView.p pVar, RecyclerView.u uVar, d dVar) {
            super.onInitializeAccessibilityNodeInfo(pVar, uVar, dVar);
            ViewPager2.this.mAccessibilityProvider.onLmInitializeAccessibilityNodeInfo(dVar);
        }
    ...
    public void addItemDecoration(RecyclerView.h hVar, int i) {
        this.mRecyclerView.addItemDecoration(hVar, i);
    }

    public RecyclerView.h getItemDecorationAt(int i) {
    ...
    public abstract class AccessibilityProvider {
        ...
        void onLmInitializeAccessibilityNodeInfo(d dVar) {
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        PageAwareAccessibilityProvider() {
            super();
            this.mActionPageForward = new g() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.1
            ...
            this.mActionPageBackward = new g() { // from class: androidx.viewpager2.widget.ViewPager2.PageAwareAccessibilityProvider.2
                @Override // androidx.core.h.a.g
                public boolean perform(View view, g.a aVar) {
                    PageAwareAccessibilityProvider.this.setCurrentItemFromAccessibilityCommand(((ViewPager2) view).getCurrentItem() - 1);
                    return true;
        ...
        public void onInitialize(CompositeOnPageChangeCallback compositeOnPageChangeCallback, RecyclerView recyclerView) {
            ...
            if (w.f(ViewPager2.this) == 0) {
                w.b((View) ViewPager2.this, 1);
            }
        }
        ...
        void updatePageAccessibilityActions() {
            ...
            w.c(viewPager2, 16908360);
            w.c(viewPager2, 16908361);
            w.c(viewPager2, 16908358);
            w.c(viewPager2, 16908359);
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                    w.a(viewPager2, new d.a(i, null), null, this.mActionPageForward);
                }
                if (ViewPager2.this.mCurrentItem > 0) {
                    w.a(viewPager2, new d.a(i2, null), null, this.mActionPageBackward);
                    return;
                }
                return;
            }
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                w.a(viewPager2, new d.a(16908359, null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                w.a(viewPager2, new d.a(16908358, null), null, this.mActionPageBackward);
            }
        }
        ...
        private void addCollectionInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (ViewPager2.this.getAdapter() == null) {
                ...
                i = 0;
                d.a(accessibilityNodeInfo).a(d.b.a(i, i2, false, 0));
            }
            i2 = 0;
            d.a(accessibilityNodeInfo).a(d.b.a(i, i2, false, 0));
        }
