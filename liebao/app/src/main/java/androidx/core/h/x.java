...
public final class x {
    ...
    private static Method f1749a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f1749a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float d(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f1749a) != null) {
            try {
