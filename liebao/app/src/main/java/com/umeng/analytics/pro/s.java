...
public class s {
    ...
    private static final String f6620a = "fs_lc_tl_uapp";
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final s f6625a = new s();
    ...
    public void a(String str, String str2, long j, int i, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                UMWorkDispatch.sendEvent(g, o.a.f6596a, CoreProtocol.getInstance(g), jSONObject);
                return;
            }
            UMLog.aq(j.l, 0, "\\|");
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String d2 = y.a().d(UMGlobalContext.getAppContext(g));
                ...
                UMWorkDispatch.sendEvent(g, o.a.f6597b, CoreProtocol.getInstance(g), jSONObject);
            }
        } catch (Throwable unused2) {
        }
    }
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f6620a, null);
    ...
    private void c(Context context) {
        try {
            if (this.h != null) {
                PreferenceWrapper.getDefault(g).edit().putString(f6620a, this.h.toString()).commit();
            }
        } catch (Throwable unused) {
        }
    }
