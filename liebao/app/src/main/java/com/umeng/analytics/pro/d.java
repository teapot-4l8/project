...
public class d {
    ...
    public static final String f6496a = "appkey";
    ...
    public static final String f6497b = "channel";

    /* renamed from: c  reason: collision with root package name */
    public static final String f6498c = "secret";

    /* renamed from: d  reason: collision with root package name */
    public static final String f6499d = "app_version";

    /* renamed from: e  reason: collision with root package name */
    public static final String f6500e = "version_code";
    ...
    public static final String f6501q = "end_time";
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", "event_name", JThirdPlatFormInterface.KEY_TOKEN, "time", "ip", ak.O, "region", "city", "browser", ak.x, ak.F, "device_version", ak.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
