...
public class UMConfigure {
    ...
    */
    private static void enterRTDModeIfNeeded(Context context) {
        ...
        String a2 = com.umeng.common.b.a(context, AnalyticsConfig.RTD_SP_FILE, AnalyticsConfig.DEBUG_KEY);
        ...
        if (!TextUtils.isEmpty(a3)) {
            try {
                longValue = Long.valueOf(a3).longValue();
            } catch (Throwable unused) {
            }
            if (!TextUtils.isEmpty(a4)) {
                try {
                    longValue2 = Long.valueOf(a4).longValue();
                ...
                if (longValue != 0 || longValue2 == 0) {
                    ...
                    hashMap.put(AnalyticsConfig.DEBUG_KEY, a2);
                    if (AnalyticsConfig.isRealTimeDebugMode()) {
                        return;
                    }
    ...
    /* JADX WARN: Type inference failed for: r3v13, types: [com.umeng.commonsdk.UMConfigure$3] */
    /* JADX WARN: Type inference failed for: r3v19, types: [com.umeng.commonsdk.UMConfigure$2] */
    /* JADX WARN: Type inference failed for: r3v23, types: [com.umeng.commonsdk.UMConfigure$1] */
    public static void init(Context context, String str, String str2, int i, String str3) {
        ...
        if (context == null) {
            ...
            try {
                ...
                if (com.umeng.commonsdk.statistics.b.f6817a.indexOf("e") >= 0 && (cls = Class.forName("com.umeng.analytics.MobclickAgent")) != null && (declaredMethod7 = cls.getDeclaredMethod("disableExceptionCatch", new Class[0])) != null) {
    ...
    private static void setLatencyWindow(long j) {
        com.umeng.commonsdk.statistics.a.f6816c = ((int) j) * 1000;
    }
    ...
    private static void setWraperType(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (str.equals(WRAPER_TYPE_NATIVE)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_NATIVE;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_NATIVE;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_X)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_COCOS2DX_X;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_COCOS2DX_X;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_XLUA)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_COCOS2DX_XLUA;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_COCOS2DX_XLUA;
            } else if (str.equals(WRAPER_TYPE_UNITY)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_UNITY;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_UNITY;
            } else if (str.equals(WRAPER_TYPE_REACTNATIVE)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_REACTNATIVE;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_REACTNATIVE;
            } else if (str.equals(WRAPER_TYPE_PHONEGAP)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_PHONEGAP;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_PHONEGAP;
            } else if (str.equals(WRAPER_TYPE_WEEX)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_WEEX;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_WEEX;
            } else if (str.equals(WRAPER_TYPE_HYBRID)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_HYBRID;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_HYBRID;
            } else if (str.equals(WRAPER_TYPE_FLUTTER)) {
                com.umeng.commonsdk.stateless.a.f6797a = WRAPER_TYPE_FLUTTER;
                com.umeng.commonsdk.statistics.a.f6814a = WRAPER_TYPE_FLUTTER;
            }
        }
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        com.umeng.commonsdk.stateless.a.f6798b = str2;
        com.umeng.commonsdk.statistics.a.f6815b = str2;
    }
