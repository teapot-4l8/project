...
public class d {
    ...
    public static final long f6711a = 1000;

    /* renamed from: b  reason: collision with root package name */
    public static final String f6712b = "_LAST_FIELD";

    /* renamed from: c  reason: collision with root package name */
    public static final String f6713c = "3758096383";

    /* renamed from: d  reason: collision with root package name */
    public static final String f6714d = "2147483647";

    /* renamed from: e  reason: collision with root package name */
    public static final String f6715e = "262143";
    ...
    public static String[] k = new String[EnumC0166d.values().length];
    ...
    static {
        ...
        for (int i5 = 0; i5 < EnumC0166d.values().length; i5++) {
            k[i5] = EnumC0166d.values()[i5].toString();
        }
        Map<String, String[]> map4 = l;
        if (map4 != null) {
            map4.put(EnumC0166d.class.getName(), k);
        }
    }

    public static boolean a(String str) {
        return (str == null || str.length() <= 0 || f6712b.equalsIgnoreCase(str)) ? false : true;
    }
