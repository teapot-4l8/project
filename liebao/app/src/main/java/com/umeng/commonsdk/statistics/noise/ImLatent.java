...
public class ImLatent implements d {
    ...
    private final long _ONE_HOURS_IN_MS = JConstants.HOUR;
    ...
    public void onImprintChanged(ImprintHandler.a aVar) {
        ...
        this.latentHour = (intValue > 36 ? intValue : 360) * JConstants.HOUR;
        int intValue2 = Integer.valueOf(aVar.a(ak.aR, "0")).intValue();
        intValue2 = (intValue2 < 1 || intValue2 > 1800) ? 0 : 0;
        if (intValue2 == 0) {
            if (a.f6816c <= 0 || a.f6816c > 1800000) {
                this.latentWindow = 10;
                return;
            } else {
                this.latentWindow = a.f6816c;
                return;
            }
        }
