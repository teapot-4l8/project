...
public final class AgentWeb {
    ...
    private a<String, Object> mJavaObjects;
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        if (agentBuilder.mJavaObject != null && !agentBuilder.mJavaObject.isEmpty()) {
            this.mJavaObjects.putAll(agentBuilder.mJavaObject);
            String str = TAG;
    ...
    public static AgentBuilder with(d dVar) {
        e activity = dVar.getActivity();
        if (activity == null) {
            throw new NullPointerException("activity can not be null .");
        }
        return new AgentBuilder(activity, dVar);
    }
    ...
    private void doCompat() {
        a<String, Object> aVar = this.mJavaObjects;
    ...
    public static final class AgentBuilder {
        ...
        private a<String, Object> mJavaObject;
        ...
        public AgentBuilder(Activity activity, d dVar) {
            this.mTag = -1;
