...
public class DefaultDesignUIController extends DefaultUIController {
    ...
    private void showChooserInternal(WebView webView, String str, String[] strArr, final Handler.Callback callback) {
        ...
        if (Build.VERSION.SDK_INT < 17 || !activity.isDestroyed()) {
            ...
            ((RecyclerView) this.mBottomSheetDialog.getDelegate().b(4097)).setAdapter(getAdapter(strArr, callback));
    ...
    private RecyclerView.a getAdapter(final String[] strArr, final Handler.Callback callback) {
        return new RecyclerView.a<BottomSheetHolder>() { // from class: com.just.agentweb.DefaultDesignUIController.2
    ...
    /* loaded from: classes.dex */
    public static class BottomSheetHolder extends RecyclerView.x {
        TextView mTextView;
