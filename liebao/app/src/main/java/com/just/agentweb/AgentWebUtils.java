...
public class AgentWebUtils {
    ...
    public static File createFileByName(Context context, String str, boolean z) {
    ...
    static String getDiskExternalCacheDir(Context context) {
        ...
        if ("mounted".equals(b.a(externalCacheDir))) {
    ...
    private static String getRealPathBelowVersion(Context context, Uri uri) {
        ...
        String[] strArr = {"_data"};
        Cursor d2 = new androidx.loader.b.b(context, uri, strArr, null, null, null).d();
        if (d2 != null) {
            d2.moveToFirst();
            str = d2.getString(d2.getColumnIndex(strArr[0]));
            d2.close();
        } else {
            str = null;
        }
    ...
    public static boolean hasPermission(Context context, List<String> list) {
        ...
        for (String str : list) {
            ...
            String a2 = d.a(str);
            if (!TextUtils.isEmpty(a2) && d.a(context, a2, context.getPackageName()) != 0) {
                return false;
            }
        }
        return true;
