...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int i) {
        aw a2 = aw.a(this.view.getContext(), i, R.styleable.TextAppearance);
        if (a2.g(R.styleable.TextAppearance_android_textColor)) {
            this.collapsedTextColor = a2.e(R.styleable.TextAppearance_android_textColor);
        }
        if (a2.g(R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = a2.e(R.styleable.TextAppearance_android_textSize, (int) this.collapsedTextSize);
        }
        this.collapsedShadowColor = a2.a(R.styleable.TextAppearance_android_shadowColor, 0);
        this.collapsedShadowDx = a2.a(R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.collapsedShadowDy = a2.a(R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.collapsedShadowRadius = a2.a(R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a2.b();
    ...
    public void setExpandedTextAppearance(int i) {
        aw a2 = aw.a(this.view.getContext(), i, R.styleable.TextAppearance);
        if (a2.g(R.styleable.TextAppearance_android_textColor)) {
            this.expandedTextColor = a2.e(R.styleable.TextAppearance_android_textColor);
        }
        if (a2.g(R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = a2.e(R.styleable.TextAppearance_android_textSize, (int) this.expandedTextSize);
        }
        this.expandedShadowColor = a2.a(R.styleable.TextAppearance_android_shadowColor, 0);
        this.expandedShadowDx = a2.a(R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.expandedShadowDy = a2.a(R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.expandedShadowRadius = a2.a(R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a2.b();
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    private void calculateBaseOffsets() {
        ...
        int a2 = e.a(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        int i = a2 & 112;
        if (i == 48) {
        ...
        int a3 = e.a(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = a3 & 112;
        if (i3 == 48) {
    ...
    private boolean calculateIsRtl(CharSequence charSequence) {
        return (w.g(this.view) == 1 ? androidx.core.f.e.f1584d : androidx.core.f.e.f1583c).a(charSequence, 0, charSequence.length());
    }
