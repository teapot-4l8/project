...
public final class zzbrh implements zzesa<zzbzl<zzbtq>> {
    ...
    private zzbrh(zzesn<zzbvl> zzesnVar, zzesn<Executor> zzesnVar2) {
        this.zzeyk = zzesnVar;
        this.zzeyl = zzesnVar2;
    }

    public static zzbrh zzo(zzesn<zzbvl> zzesnVar, zzesn<Executor> zzesnVar2) {
        return new zzbrh(zzesnVar, zzesnVar2);
    }
