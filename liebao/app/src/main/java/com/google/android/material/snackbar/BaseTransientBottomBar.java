...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public BaseTransientBottomBar(ViewGroup viewGroup, View view, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        w.d(this.view, 1);
        w.b((View) this.view, 1);
        w.b((View) this.view, true);
        w.a(this.view, new s() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.2
            @Override // androidx.core.h.s
            public ae onApplyWindowInsets(View view2, ae aeVar) {
                view2.setPadding(view2.getPaddingLeft(), view2.getPaddingTop(), view2.getPaddingRight(), aeVar.d());
                return aeVar;
            }
        });
        w.a(this.view, new a() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.3
    ...
    void animateViewIn() {
        ...
        if (USE_OFFSET_API) {
            w.f(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.9
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    w.f(BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            c.a(this.accessibilityManager, aVar);
        ...
        protected void onDetachedFromWindow() {
            ...
            c.b(this.accessibilityManager, this.touchExplorationStateChangeListener);
        }
