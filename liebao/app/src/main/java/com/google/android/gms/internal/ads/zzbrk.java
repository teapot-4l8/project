...
public final class zzbrk implements zzesa<zzbzl<zzbxb>> {
    ...
    private zzbrk(zzesn<zzclp> zzesnVar, zzesn<Executor> zzesnVar2, zzesn<zzcqv> zzesnVar3) {
        this.zzgab = zzesnVar;
        this.zzeyl = zzesnVar2;
        this.zzgac = zzesnVar3;
    }

    public static zzbrk zzi(zzesn<zzclp> zzesnVar, zzesn<Executor> zzesnVar2, zzesn<zzcqv> zzesnVar3) {
        return new zzbrk(zzesnVar, zzesnVar2, zzesnVar3);
    }
