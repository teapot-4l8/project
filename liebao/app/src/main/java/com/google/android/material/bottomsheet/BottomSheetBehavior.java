...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.b<V> {
    ...
    int collapsedOffset;
    private final c.a dragCallback;
    ...
    public BottomSheetBehavior() {
        ...
        this.state = 4;
        this.dragCallback = new c.a() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.2
                ...
                if (f2 < 0.0f) {
                    if (BottomSheetBehavior.this.fitToContents) {
                        ...
                        if (BottomSheetBehavior.this.viewDragHelper.a(view.getLeft(), i)) {
                            ...
                            w.a(view, new SettleRunnable(view, i3));
                            return;
                        }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        if (w.s(coordinatorLayout) && !w.s(v)) {
        ...
        int i2 = this.state;
        if (i2 == 3) {
            w.f(v, getExpandedOffset());
        } else if (i2 == 6) {
            w.f(v, this.halfExpandedOffset);
        } else if (this.hideable && i2 == 5) {
            w.f(v, this.parentHeight);
        } else {
            int i3 = this.state;
            if (i3 == 4) {
                w.f(v, this.collapsedOffset);
            } else if (i3 == 1 || i3 == 2) {
                w.f(v, top - v.getTop());
            }
        }
        if (this.viewDragHelper == null) {
            this.viewDragHelper = c.a(coordinatorLayout, this.dragCallback);
        }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (this.ignoreEvents || (cVar = this.viewDragHelper) == null || !cVar.a(motionEvent)) {
            WeakReference<View> weakReference2 = this.nestedScrollingChildRef;
            View view2 = weakReference2 != null ? weakReference2.get() : null;
            return (actionMasked != 2 || view2 == null || this.ignoreEvents || this.state == 1 || coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || Math.abs(((float) this.initialY) - motionEvent.getY()) <= ((float) this.viewDragHelper.b())) ? false : true;
        }
        return true;
    }
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        if (v.isShown()) {
            ...
            this.velocityTracker.addMovement(motionEvent);
            if (actionMasked == 2 && !this.ignoreEvents && Math.abs(this.initialY - motionEvent.getY()) > this.viewDragHelper.b()) {
    ...
    void startSettlingAnimation(View view, int i) {
        ...
        if (this.viewDragHelper.a(view, view.getLeft(), i2)) {
            setStateInternal(2);
            w.a(view, new SettleRunnable(view, i));
            return;
        }
        setStateInternal(i);
    }
                ...
                if (childAt != this.viewRef.get()) {
                    if (!z) {
                        ...
                        if (map != null && map.containsKey(childAt)) {
                            w.b(childAt, this.importantForAccessibilityMap.get(childAt).intValue());
                        }
                    } else {
