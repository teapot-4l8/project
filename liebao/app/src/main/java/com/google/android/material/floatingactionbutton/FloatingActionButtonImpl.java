...
public class FloatingActionButtonImpl {
    ...
    public void setBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        Drawable g = a.g(createShapeDrawable());
        this.shapeDrawable = g;
        a.a(g, colorStateList);
        if (mode != null) {
            a.a(this.shapeDrawable, mode);
        }
        Drawable g2 = a.g(createShapeDrawable());
        this.rippleDrawable = g2;
        a.a(g2, RippleUtils.convertToRippleDrawableColor(colorStateList2));
        if (i > 0) {
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            a.a(drawable, RippleUtils.convertToRippleDrawableColor(colorStateList));
        }
    }
    ...
    public CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(b.c(context, R.color.design_fab_stroke_top_outer_color), b.c(context, R.color.design_fab_stroke_top_inner_color), b.c(context, R.color.design_fab_stroke_end_inner_color), b.c(context, R.color.design_fab_stroke_end_outer_color));
    ...
    private boolean shouldAnimateVisibilityChange() {
        return w.A(this.view) && !this.view.isInEditMode();
    }
