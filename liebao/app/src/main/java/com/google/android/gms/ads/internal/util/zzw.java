    ...
    public final String getDefaultUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(zzaak.zzeiz)) {
            if (ClientLibraryUtils.isPackageSide()) {
                str = (String) zzbr.zza(context, new zzbt(zzaak, context));
            } else {
                str = (String) zzbr.zza(context, new zzbw(zzaak, GooglePlayServicesUtilLight.getRemoteContext(context), context));
            }
            zzaak.zzeiz = str;
        }
        return zzaak.zzeiz;
