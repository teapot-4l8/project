...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        w.a(this, new s() { // from class: com.google.android.material.appbar.CollapsingToolbarLayout.1
            ...
            public ae onApplyWindowInsets(View view, ae aeVar) {
                return CollapsingToolbarLayout.this.onWindowInsetChanged(aeVar);
            }
        });
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (b2 > 0) {
            this.statusBarScrim.setBounds(0, -this.currentOffset, getWidth(), b2 - this.currentOffset);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            boolean z2 = w.D(view) && this.dummyView.getVisibility() == 0;
            this.drawCollapsingTitle = z2;
            if (z2) {
                boolean z3 = w.g(this) == 1;
                View view2 = this.toolbarDirectChild;
                if (view2 == null) {
                    view2 = this.toolbar;
                }
    ...
    public void setScrimsShown(boolean z) {
        setScrimsShown(z, w.A(this) && !isInEditMode());
    }
    ...
    public void setContentScrimResource(int i) {
        setContentScrim(b.a(getContext(), i));
    }
    ...
    public void setStatusBarScrim(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (mutate != null) {
                ...
                a.b(this.statusBarScrim, w.g(this));
    ...
    public void setStatusBarScrimResource(int i) {
        setStatusBarScrim(b.a(getContext(), i));
    }
    ...
    public int getScrimVisibleHeightTrigger() {
        ...
        int l = w.l(this);
        if (l > 0) {
            return Math.min((l * 2) + b2, getHeight());
        }
        return getHeight() / 3;
    }
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            int b2 = CollapsingToolbarLayout.this.lastInsets != null ? CollapsingToolbarLayout.this.lastInsets.b() : 0;
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (i3 == 1) {
                    viewOffsetHelper.setTopAndBottomOffset(androidx.core.b.a.a(-i, 0, CollapsingToolbarLayout.this.getMaxOffsetForPinChild(childAt)));
                } else if (i3 == 2) {
                    viewOffsetHelper.setTopAndBottomOffset(Math.round((-i) * layoutParams.parallaxMult));
                }
            }
            CollapsingToolbarLayout.this.updateScrimVisibility();
            if (CollapsingToolbarLayout.this.statusBarScrim != null && b2 > 0) {
                w.e(CollapsingToolbarLayout.this);
            }
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(Math.abs(i) / ((CollapsingToolbarLayout.this.getHeight() - w.l(CollapsingToolbarLayout.this)) - b2));
        }
    }
}
