...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final e.a<Tab> tabPool = new e.c(16);
    ...
    private final e.a<TabView> tabViewPool;
    ...
    void setPagerAdapter(a aVar, boolean z) {
    ...
    void populateFromPagerAdapter() {
        ...
        if (aVar != null) {
            int b2 = aVar.b();
            for (int i = 0; i < b2; i++) {
                addTab(newTab().setText(this.pagerAdapter.c(i)), false);
            }
    ...
    private TabView createTabView(Tab tab) {
        e.a<TabView> aVar = this.tabViewPool;
    ...
    */
    ...
    private void animateToTab(int i) {
        ...
        if (getWindowToken() == null || !w.A(this) || this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private int calculateScrollXForTab(int i, float f) {
        if (this.mode == 0) {
            ...
            return w.g(this) == 0 ? left + i3 : left - i3;
        }
        return 0;
    }

    private void applyModeAndGravity() {
        w.a(this.slidingTabIndicator, this.mode == 0 ? Math.max(0, this.contentInsetStart - this.tabPaddingStart) : 0, 0, 0, 0);
        int i = this.mode;
        if (i == 0) {
    ...
    public static class Tab {
        ...
        public Tab setIcon(int i) {
            ...
            return setIcon(androidx.appcompat.a.a.a.b(tabLayout.getContext(), i));
        }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            w.a(this, TabLayout.this.tabPaddingStart, TabLayout.this.tabPaddingTop, TabLayout.this.tabPaddingEnd, TabLayout.this.tabPaddingBottom);
            setGravity(17);
        ...
        public void updateBackgroundDrawable(Context context) {
            if (TabLayout.this.tabBackgroundResId != 0) {
                Drawable b2 = androidx.appcompat.a.a.a.b(context, TabLayout.this.tabBackgroundResId);
            ...
            if (TabLayout.this.tabRippleColorStateList != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    androidx.core.graphics.drawable.a.a(g, convertToRippleDrawableColor);
        ...
        final void update() {
            ...
            if (customView != null) {
                ...
                if (textView2 != null) {
                    this.defaultMaxLines = i.a(textView2);
                }
            ...
            if (this.customView == null) {
                ...
                if (tab != null && tab.getIcon() != null) {
                    drawable = androidx.core.graphics.drawable.a.g(tab.getIcon()).mutate();
                }
                if (drawable != null) {
                    androidx.core.graphics.drawable.a.a(drawable, TabLayout.this.tabIconTint);
                    if (TabLayout.this.tabIconTintMode != null) {
                        androidx.core.graphics.drawable.a.a(drawable, TabLayout.this.tabIconTintMode);
                    }
                }
                if (this.textView == null) {
                    ...
                    this.defaultMaxLines = i.a(textView3);
                }
                i.a(this.textView, TabLayout.this.tabTextAppearance);
        ...
        private void updateTextAndIcon(TextView textView, ImageView imageView) {
            Tab tab = this.tab;
            Drawable mutate = (tab == null || tab.getIcon() == null) ? null : androidx.core.graphics.drawable.a.g(this.tab.getIcon()).mutate();
            Tab tab2 = this.tab;
            ...
            if (imageView != null) {
                ...
                if (TabLayout.this.inlineLabel) {
                    if (dpToPx != h.b(marginLayoutParams)) {
                        h.a(marginLayoutParams, dpToPx);
            ...
            Tab tab3 = this.tab;
            ay.a(this, z ? null : tab3 != null ? tab3.contentDesc : null);
        }
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i4 >= 0 && this.indicatorRight > i4) {
                Drawable g = androidx.core.graphics.drawable.a.g(TabLayout.this.tabSelectedIndicator != null ? TabLayout.this.tabSelectedIndicator : this.defaultSelectionIndicator);
                ...
                if (this.selectedIndicatorPaint != null) {
                    if (Build.VERSION.SDK_INT == 21) {
                        ...
                        androidx.core.graphics.drawable.a.a(g, this.selectedIndicatorPaint.getColor());
                    }
                }
                g.draw(canvas);
            }
