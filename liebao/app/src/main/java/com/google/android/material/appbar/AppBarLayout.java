...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        w.a(this, obtainStyledAttributes.getDrawable(R.styleable.AppBarLayout_android_background));
        ...
        w.a(this, new s() { // from class: com.google.android.material.appbar.AppBarLayout.1
            @Override // androidx.core.h.s
            public ae onApplyWindowInsets(View view, ae aeVar) {
                return AppBarLayout.this.onWindowInsetChanged(aeVar);
            }
        });
    }
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (l == 0) {
            int childCount = getChildCount();
            l = childCount >= 1 ? w.l(getChildAt(childCount - 1)) : 0;
            if (l == 0) {
                return getHeight() / 3;
            }
        }
    ...
    ae onWindowInsetChanged(ae aeVar) {
        ae aeVar2 = w.s(this) ? aeVar : null;
        if (!c.a(this.lastInsets, aeVar2)) {
            this.lastInsets = aeVar2;
            invalidateScrollRanges();
        }
        return aeVar;
    }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.android.material.appbar.ViewOffsetBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.b
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, a.a(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    round = w.l(childAt) + t.getTopInset();
                } else {
            ...
            this.offsetToChildIndexOnLayout = -1;
            setTopAndBottomOffset(a.a(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, T t, int i, int i2, int i3) {
            ...
            if (i2 != 0 && topBottomOffsetForScrollingSibling >= i2 && topBottomOffsetForScrollingSibling <= i3) {
                ...
                if (topBottomOffsetForScrollingSibling != a2) {
                    int interpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, a2) : a2;
        ...
        */
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < size; i++) {
                CoordinatorLayout.b b2 = ((CoordinatorLayout.e) dependents.get(i).getLayoutParams()).b();
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.getTop() + topAndBottomOffset <= 0 && bottom >= 0) {
                    ...
                    savedState.firstVisibleChildAtMinimumHeight = bottom == w.l(childAt) + t.getTopInset();
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        @Override // com.google.android.material.appbar.HeaderScrollingViewBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.b
        public /* bridge */ /* synthetic */ boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        private void offsetChildAsNeeded(View view, View view2) {
            ...
            if (b2 instanceof BaseBehavior) {
                w.f(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) b2).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
