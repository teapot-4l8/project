...
public class ShadowDrawableWrapper extends c {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = b.c(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = b.c(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = b.c(context, R.color.design_fab_shadow_end_color);
