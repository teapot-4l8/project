...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        if ((i5 == -1 || i5 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            if (w.s(findFirstDependency) && !w.s(view)) {
                w.b(view, true);
                if (w.s(view)) {
                    view.requestLayout();
                    return true;
    ...
    public void layoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (findFirstDependency != null) {
            ...
            if (lastWindowInsets != null && w.s(coordinatorLayout) && !w.s(view)) {
                rect.left += lastWindowInsets.a();
                rect.right -= lastWindowInsets.c();
            }
            Rect rect2 = this.tempRect2;
            e.a(resolveGravity(eVar.f1390c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i);
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return a.a((int) (overlapRatioForOffset * i), 0, i);
    }
