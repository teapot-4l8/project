...
public final class zzjk {
    ...
    */
    private static void zza(zzjj zzjjVar, StringBuilder sb, int i) {
        Method[] declaredMethods;
        boolean equals;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzjjVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zza(concat), zzhy.zza(method2, zzjjVar, new Object[0]));
                }
            }
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(concat2), zzhy.zza(method3, zzjjVar, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzhy.zza(method4, zzjjVar, new Object[0]);
                    if (method5 == null) {
                                ...
                                if (!(zza instanceof Float)) {
                                    if (!(zza instanceof Double)) {
                                        if (zza instanceof String) {
                                            ...
                                            equals = zza.equals(zzgp.zza);
                                        } else {
                                            equals = !(zza instanceof zzjj) ? false : false;
                                        }
                                    }
                                }
                            }
                        ...
                        z = ((Boolean) zzhy.zza(method5, zzjjVar, new Object[0])).booleanValue();
                    }
                    if (z) {
        ...
        if (zzjjVar instanceof zzhy.zzd) {
            Iterator<Map.Entry<zzhy.zzc, Object>> zzd = ((zzhy.zzd) zzjjVar).zzc.zzd();
            if (zzd.hasNext()) {
                zzd.next().getKey();
                throw new NoSuchMethodError();
            }
        }
        zzhy zzhyVar = (zzhy) zzjjVar;
        if (zzhyVar.zzb != null) {
            zzhyVar.zzb.zza(sb, i);
        }
    }
