...
public class CircularBorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{a.a(this.topOuterStrokeColor, this.currentBorderTintColor), a.a(this.topInnerStrokeColor, this.currentBorderTintColor), a.a(a.b(this.topInnerStrokeColor, 0), this.currentBorderTintColor), a.a(a.b(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), a.a(this.bottomInnerStrokeColor, this.currentBorderTintColor), a.a(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
