...
public class Chip extends h implements ChipDrawable.Delegate {
    ...
    private void updatePaddingInternal() {
        ...
        if (w.j(this) != chipStartPadding) {
            w.a(this, w.i(this), getPaddingTop(), (int) chipStartPadding, getPaddingBottom());
        }
    }
    ...
    public void setChipDrawable(ChipDrawable chipDrawable) {
        ...
        if (chipDrawable2 != chipDrawable) {
            ...
            if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
                ...
                w.a(this, this.ripple);
                return;
            }
            this.chipDrawable.setUseCompatRipple(true);
            w.a(this, this.chipDrawable);
        }
    }
    ...
    private float calculateTextOffsetFromStart(ChipDrawable chipDrawable) {
        ...
        return w.g(this) == 0 ? chipStartPadding : -chipStartPadding;
    }
    ...
    public class ChipTouchHelper extends a {
        ...
        protected void onPopulateNodeForVirtualView(int i, d dVar) {
            if (Chip.this.hasCloseIcon()) {
                ...
                dVar.a(d.a.f1668e);
                dVar.g(Chip.this.isEnabled());
                return;
            }
            dVar.e("");
            dVar.b(Chip.EMPTY_BOUNDS);
        }

        @Override // androidx.customview.b.a
        protected void onPopulateNodeForHost(d dVar) {
            dVar.a(Chip.this.chipDrawable != null && Chip.this.chipDrawable.isCheckable());
