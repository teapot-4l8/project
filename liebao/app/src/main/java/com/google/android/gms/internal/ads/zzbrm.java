...
public final class zzbrm implements zzesa<zzbzl<zzbtq>> {
    ...
    private zzbrm(zzesn<zzclp> zzesnVar, zzesn<Executor> zzesnVar2, zzesn<zzcqv> zzesnVar3) {
        this.zzgab = zzesnVar;
        this.zzeyl = zzesnVar2;
        this.zzgac = zzesnVar3;
    }

    public static zzbrm zzj(zzesn<zzclp> zzesnVar, zzesn<Executor> zzesnVar2, zzesn<zzcqv> zzesnVar3) {
        return new zzbrm(zzesnVar, zzesnVar2, zzesnVar3);
    }
