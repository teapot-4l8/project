...
public final class zzckm implements zzesa<zzbzl<zzbxn>> {
    ...
    private zzckm(zzesn<zzcku> zzesnVar, zzesn<Executor> zzesnVar2) {
        this.zzeyk = zzesnVar;
        this.zzeyl = zzesnVar2;
    }

    public static zzckm zzy(zzesn<zzcku> zzesnVar, zzesn<Executor> zzesnVar2) {
        return new zzckm(zzesnVar, zzesnVar2);
    }
