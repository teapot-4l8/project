...
public final class zzbae {
    ...
    public final int zzd(Context context, int i) {
        ...
        return Math.round(i / this.zzejs);
    }
    ...
    public final void zza(ViewGroup viewGroup, zzvt zzvtVar, String str, String str2) {
        zzbao.zzez(str2);
        zza(viewGroup, zzvtVar, str, -65536, -16777216);
    }

    public final void zza(ViewGroup viewGroup, zzvt zzvtVar, String str) {
        zza(viewGroup, zzvtVar, str, -16777216, -1);
    }

    private static void zza(ViewGroup viewGroup, zzvt zzvtVar, String str, int i, int i2) {
        ...
        frameLayout.addView(textView, new FrameLayout.LayoutParams(zzvtVar.widthPixels - zze, zzvtVar.heightPixels - zze, 17));
    ...
    public static String zzbp(Context context) {
        ...
        return zzes(((contentResolver == null ? null : Settings.Secure.getString(contentResolver, "android_id")) == null || zzaap()) ? "emulator" : "emulator");
    }
    ...
    public static String zza(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            i = ("loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) && (zzejm.equalsIgnoreCase(className) || zzejn.equalsIgnoreCase(className) || zzejo.equalsIgnoreCase(className) || zzejp.equalsIgnoreCase(className) || zzejq.equalsIgnoreCase(className) || zzejr.equalsIgnoreCase(className))) ? 0 : i2;
        }
    ...
    public static void zza(Context context, String str, String str2, Bundle bundle, boolean z, zzbaf zzbafVar) {
        Context applicationContext = context.getApplicationContext();
        if (applicationContext == null) {
            applicationContext = context;
        }
        bundle.putString(ak.x, Build.VERSION.RELEASE);
        ...
        zzbafVar.zzen(appendQueryParameter.toString());
    }
