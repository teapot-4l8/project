...
public final class IndicatorViewController {
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        return w.A(this.textInputView) && this.textInputView.isEnabled() && !(this.captionToShow == this.captionDisplayed && textView != null && TextUtils.equals(textView.getText(), charSequence));
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            w.a(this.indicatorArea, w.i(this.textInputView.getEditText()), 0, w.j(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void addIndicator(TextView textView, int i) {
        if (this.indicatorArea == null && this.captionArea == null) {
            ...
            this.indicatorArea.addView(new a(this.context), new LinearLayout.LayoutParams(0, 0, 1.0f));
