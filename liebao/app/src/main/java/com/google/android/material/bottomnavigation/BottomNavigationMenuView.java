...
public class BottomNavigationMenuView extends ViewGroup implements n {
    ...
    private final e.a<BottomNavigationItemView> itemPool;
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.set.setInterpolator(new androidx.d.a.a.b());
        this.set.a(new TextScale());
    ...
    private BottomNavigationItemView getNewItem() {
        BottomNavigationItemView a2 = this.itemPool.a();
