...
public class MaterialButton extends g {
    ...
    @Override // androidx.appcompat.widget.g, androidx.core.h.v
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int measuredWidth = (((((getMeasuredWidth() - measureText) - w.j(this)) - i3) - this.iconPadding) - w.i(this)) / 2;
        if (isLayoutRTL()) {
    ...
    private void updateIcon() {
        ...
        if (drawable != null) {
            ...
            this.icon = mutate;
            androidx.core.graphics.drawable.a.a(mutate, this.iconTint);
            PorterDuff.Mode mode = this.iconTintMode;
            if (mode != null) {
                androidx.core.graphics.drawable.a.a(this.icon, mode);
            }
            int i = this.iconSize;
            if (i == 0) {
