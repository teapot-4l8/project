...
public final class zzb {
    ...
    */
        ...
        try {
            ...
            if (j >= 0) {
                ...
                if (randomAccessFile.readInt() == 1347094023) {
                    ...
                    if (zzc >= longValue) {
                    ...
                    } else if (zzi.zzd(byteBuffer) + zzc == longValue) {
                        if (zzc < 32) {
                        ...
                        while (zza2.hasRemaining()) {
                            ...
                            } else if (zza2.getInt() != 1896449818) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private static X509Certificate[] zza(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) {
        String str;
        byte[] bArr;
        Pair create;
        boolean z;
        ...
        while (true) {
            ...
            try {
                ...
                sb7.append(i2);
                throw new SecurityException(sb7.toString(), e5);
            }
        }
    }

    private static byte[][] zza(int[] iArr, zzc[] zzcVarArr) {
        long j;
