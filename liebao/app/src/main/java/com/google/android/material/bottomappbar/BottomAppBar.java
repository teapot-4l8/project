...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.a {
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        ...
        w.a(this, this.materialShapeDrawable);
    }
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !w.A(this)) {
            return;
        }
    ...
    public void translateActionMenuView(ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if ((childAt.getLayoutParams() instanceof Toolbar.b) && (((Toolbar.b) childAt.getLayoutParams()).f575a & 8388615) == 8388611) {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        private boolean updateFabPositionAndVisibility(FloatingActionButton floatingActionButton, BottomAppBar bottomAppBar) {
            ((CoordinatorLayout.e) floatingActionButton.getLayoutParams()).f1391d = 17;
