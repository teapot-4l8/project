    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) {
        ...
        try {
            ...
            if (zza2.zzc == 0 || ((zza2.zzc == -1 && zza2.zza == 0) || (zza2.zzc == 1 && zza2.zzb == 0))) {
                ...
                sb2.append(i4);
                sb2.append(".");
                throw new LoadingException(sb2.toString(), (com.google.android.gms.dynamite.zzb) null);
            } else if (zza2.zzc == -1) {
                ...
                sb3.append(i5);
                throw new LoadingException(sb3.toString(), (com.google.android.gms.dynamite.zzb) null);
            }
        } catch (Throwable th) {
            if (zzaVar2.zza != null) {
                zzaVar2.zza.close();
    ...
    */
    private static int zzc(Context context, String str, boolean z) {
        ...
        try {
            ...
            throw new LoadingException("Failed to connect to dynamite module ContentResolver.", (com.google.android.gms.dynamite.zzb) null);
        } catch (Exception e3) {
            e = e3;
            cursor = null;
        } catch (Throwable th3) {
    ...
    private static DynamiteModule zza(Context context, String str, int i) {
        ...
        try {
            ...
            if (bool == null) {
                throw new LoadingException("Failed to determine which loading route to use.", (com.google.android.gms.dynamite.zzb) null);
            }
            if (bool.booleanValue()) {
            ...
            if (zza3 == null) {
                throw new LoadingException("Failed to create IDynamiteLoader.", (com.google.android.gms.dynamite.zzb) null);
            }
            if (zza3.zzb() >= 2) {
            ...
            if (ObjectWrapper.unwrap(zza2) == null) {
                throw new LoadingException("Failed to load remote module.", (com.google.android.gms.dynamite.zzb) null);
            }
    ...
    private static DynamiteModule zzb(Context context, String str, int i) {
        ...
        if (zzmVar == null) {
            throw new LoadingException("DynamiteLoaderV2 was not cached.", (com.google.android.gms.dynamite.zzb) null);
        }
        zza zzaVar = zzf.get();
        if (zzaVar == null || zzaVar.zza == null) {
            throw new LoadingException("No result cursor", (com.google.android.gms.dynamite.zzb) null);
        }
        ...
        if (context2 == null) {
            throw new LoadingException("Failed to get module context", (com.google.android.gms.dynamite.zzb) null);
        }
