...
public class ChipDrawable extends Drawable implements Drawable.Callback, e {
    ...
    private final f.a fontCallback = new f.a() { // from class: com.google.android.material.chip.ChipDrawable.1
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(a.b(-16777216, 127));
            ...
            this.debugPaint.setColor(a.b(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(a.b(-16711936, 127));
    ...
    */
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        int colorForState2 = colorStateList != null ? colorStateList.getColorForState(iArr, this.currentChipBackgroundColor) : 0;
        boolean z2 = true;
        ...
        int colorForState3 = colorStateList2 != null ? colorStateList2.getColorForState(iArr, this.currentChipStrokeColor) : 0;
        ...
        int colorForState4 = colorStateList3 != null ? colorStateList3.getColorForState(iArr, this.currentCompatRippleColor) : 0;
        ...
        int colorForState5 = (textAppearance == null || textAppearance.textColor == null) ? 0 : this.textAppearance.textColor.getColorForState(iArr, this.currentTextColor);
    ...
    public void setText(CharSequence charSequence) {
        ...
        if (this.rawText != charSequence) {
            ...
            this.unicodeWrappedText = androidx.core.f.a.a().a(charSequence);
    ...
    public void setChipIconResource(int i) {
        setChipIcon(androidx.appcompat.a.a.a.b(this.context, i));
    }
    ...
    public void setChipIcon(Drawable drawable) {
        ...
        if (chipIcon != drawable) {
            float calculateChipIconWidth = calculateChipIconWidth();
            this.chipIcon = drawable != null ? androidx.core.graphics.drawable.a.g(drawable).mutate() : null;
    ...
    public void setCloseIconResource(int i) {
        setCloseIcon(androidx.appcompat.a.a.a.b(this.context, i));
    }
    ...
    public void setCloseIcon(Drawable drawable) {
        ...
        if (closeIcon != drawable) {
            ...
            this.closeIcon = drawable != null ? androidx.core.graphics.drawable.a.g(drawable).mutate() : null;
    ...
    public void setCloseIconContentDescription(CharSequence charSequence) {
        if (this.closeIconContentDescription != charSequence) {
            this.closeIconContentDescription = androidx.core.f.a.a().a(charSequence);
            invalidateSelf();
        }
    }
    ...
    public void setCheckedIconResource(int i) {
        setCheckedIcon(androidx.appcompat.a.a.a.b(this.context, i));
    }
