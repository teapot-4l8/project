...
public abstract class ExpandableBehavior extends CoordinatorLayout.b<View> {
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, final View view, int i) {
        ...
        if (w.A(view) || (findExpandableWidget = findExpandableWidget(coordinatorLayout, view)) == null || !didStateChange(findExpandableWidget.isExpanded())) {
            return false;
        }
    ...
    public static <T extends ExpandableBehavior> T from(View view, Class<T> cls) {
        ...
        if (!(b2 instanceof ExpandableBehavior)) {
