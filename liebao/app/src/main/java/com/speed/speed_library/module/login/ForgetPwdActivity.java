...
public final class ForgetPwdActivity extends com.speed.speed_library.a.a implements View.OnClickListener {
    ...
    public final void n() {
        ...
        ((LinearLayout) d(R.id.ll_back)).setOnClickListener(forgetPwdActivity);
        ((TextView) d(R.id.tv_send_captcha)).setOnClickListener(forgetPwdActivity);
        ((Button) d(R.id.btn_forget)).setOnClickListener(forgetPwdActivity);
    }
        ...
        if (i.a(view, (LinearLayout) d(R.id.ll_back))) {
            ...
            if (cVar.a(g.a(obj).toString())) {
                ...
                if (g.a(obj2).toString().length() == 11) {
                    ...
                    a(g.a(obj3).toString(), 1);
                    return;
                }
            }
            f.a("手机号不合法", 0, 2, null);
        } else if (i.a(view, (Button) d(R.id.btn_forget)) && p()) {
            o();
        }
    }
    ...
    public final void o() {
        ...
        a2.c(obj2, obj4, g.a(obj5).toString()).b(b.b.h.a.d()).a(b.b.a.b.a.a()).a(s()).a(new b(this));
    }
        ...
        if (cVar.a(g.a(obj).toString())) {
            ...
            if (g.a(obj2).toString().length() == 11) {
                ...
                if (obj3 != null) {
                    ...
                    if (obj4 != null) {
                        if (TextUtils.isEmpty(g.a(obj4).toString())) {
                            f.a("请输入验证码", 0, 2, null);
                            return false;
                        }
                        return true;
    ...
    public static final class a implements b.b.h<Long> {
        ...
        public void a(b.b.b.b bVar) {
            i.b(bVar, "d");
            ForgetPwdActivity.this.l().a(bVar);
        }
        ...
        public void a(long j) {
            if (j > d.f5595a.b()) {
                ...
                ForgetPwdActivity.this.a(d.f5595a.b() - j);
            }
        }
    }
